...
class Media {
  ...
  onResize({
    ...
    const xMultiplier = isMobile ? 900 : isTablet ? 1400 : 1800;
    const yMultiplier = isMobile ? 500 : isTablet ? 700 : 1100;

    this.plane.scale.y =
      (this.viewport.height * (yMultiplier * this.scale)) / this.screen.height;
    this.plane.scale.x =
      (this.viewport.width * (xMultiplier * this.scale)) / this.screen.width;
